...
export default function ArchivedTodoList({ archivedTodos }: ArchivedTodoListProps) {
  ...
  return (
    <div className="mt-6">
      <h2 className="text-xl font-semibold mb-3 text-gray-700" data-testid="archived-items-heading">Archived Items</h2>
      {archivedTodos.length === 0 ? (
        <p className="text-gray-500 italic" data-testid="no-archived-items-message">No archived items.</p>
      ) : (
        <ul data-testid="archived-todo-list">
          {archivedTodos.map((todo) => (
            <li
              ...
              data-testid={`archived-todo-item-${todo.id}`} // Add test ID for archived list item
            >
              ...
              <button
                ...
                data-testid={`archived-todo-item-delete-button-${todo.id}`} // Add test ID for delete button
              >
